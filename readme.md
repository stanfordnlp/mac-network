...
**Note: In the original version of the code there was some small typo which led to models looking at the wrong images. It is fixed now, but please make sure to work with the most updated version of the repository. Thanks!**
